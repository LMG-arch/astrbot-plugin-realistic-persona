...
class LocalDataManager:
    ...
    def save_weather_data(self, date: str, weather_data: str):
        ...
        try:
            ...
            data[date] = {"data": weather_data, "timestamp": datetime.now().isoformat()}
    ...
    def get_weather_data(self, date: str) -> str | None:
        """获取天气数据"""
        try:
            data = self._load_json_file(self.weather_file)
            if date in data:
    ...
    def get_schedule_data(self, date: str) -> str | None:
        """获取日程数据"""
        try:
            data = self._load_json_file(self.schedule_file)
            if date in data:
